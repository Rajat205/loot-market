...
//     // .innerText = `Showing results for: '${q}'`;
//     // console.log(heading);
...
//     rowDiv.classList = "row row-col-sm-6 row-col-md-4 row-col-lg-2.4 row-col-xl-2.4 row-col-xxl-2 row-of-data";
...
//         .then((data) => {
//             // console.log(data);
//             // searchTerm = searchTerm.valuee

//             const a = data.filter(obj => obj.title.toLowerCase().includes(query.toLowerCase()) || obj.description.toLowerCase().includes(query.toLowerCase()) || obj.category.toLowerCase().includes(query.toLowerCase()));
//             // console.log(a);
...
//                     // console.log("for");
//                     const dataImage = a[i].image;
//                     // const dataCategory = data.category;
//                     const dataTitle = a[i].title;
//                     // const dataDescription = data[i].description;
//                     const dataPrice = a[i].price;
//                     // console.log(dataTitle, dataPrice);

//                     // .col-	.col-sm-	.col-md-	.col-lg-	.col-xl-	.col-xxl-
//                     const div = `<div class="col col-6 col-sm-6 col-md-4 col-lg-2.4 col-xl-2 col-xxl-2 data-column">
//                                      <div class="card post-card">
//                                         <img src="${dataImage}" alt="product-image" class="card-img-top card-img">
//                                         <div class="card-body body-card">
//                                             <p class="card-text title"> ${dataTitle} </p><hr>
//                                             <p class="price"> ₹${dataPrice} </p>
...
//                     container.innerHTML = rowDiv.outerHTML;
//                     // console.log(rowDiv);
//                 }
//             }
